...
const RoutePerilComponent = ({ route, navigation }) => {
    ...
    return (
        <RoutePerfil.Navigator initialRouteName="Perfil">
            <RoutePerfil.Screen name="Perfil" component={Perfil} initialParams={userParams} options={{ headerShown: false }} />
            <RoutePerfil.Screen name="About" component={About} initialParams={userParams} options={{ headerTitle: "Fundación Tercer Tiempo", headerTintColor: colors.inicioText}} />
