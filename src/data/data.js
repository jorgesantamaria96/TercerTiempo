export const CURSOS = [
  {
    ...
    detailCard:
      "En este curso vas a encontrar material para aprender a reciclar, su importancia para el medio ambiente...",
    presentation: [
      {
        item: false,
        text:
          "En este curso vas a encontrar material para aprender a reciclar, su importancia para el medio ambiente, tipos de residuos, el proceso de reciclaje, el ciclo de los diferentes materiales y campañas de comunicación que acompañan a concientizar a la sociedad",
      },
      {
        item: false,
        text:
          "Sabrás al finalizar sobre la importancia para el medio ambiente y podrás pensar en llevar este conocimiento a un emprendimiento productivo que permita mejorar el medio ambiente y te de herramientas en tu vida cotidiana!",
      },
      {
        item: false,
        ...
        },
        {
          ...
          textClass: [
            ...
            },
            {
              ...
              title: false,
              text:
                "Reducir implica prevenir la formación de residuos, modificando los modelos de producción y nuestros hábitos de consumo y adquiriendo productos responsablemente.",
            },
            {
              item: false,
              title: false,
              text:
                "Reutilizar significa volver a usar un producto para la misma función (reparándolo) o para otros usos alternativos, alargando así su vida útil.",
            },
            {
              item: false,
              title: false,
      ...
      [
        {
          ...
          textClass: [
            ...
            },
            {
              ...
              title: false,
              text:
                "Para la separación en origen doméstico2​ se usan contenedores de distintos colores ubicados en entornos urbanos o rurales:",
            },
            {
              item: true,
              title: false,
            ...
            },
            {
              ...
              title: false,
              text:
                "Contenedor marrón (orgánico):5​ En él se depositan el resto de residuos que no tienen cabida en los grupos anteriores, fundamentalmente desechos orgánicos catalogados como materia biodegradable.",
            },
            {
              item: true,
              title: false,
        ...
        },
        {
          ...
          textClass: [
            ...
            },
            {
              ...
              title: false,
              text:
                "Todos podemos organizar una campaña de reciclaje en nuestra ciudad, ya que es bastante común que no haya programas de separación, recolección y reciclaje de todos los residuos que se generan ella.",
            },
            {
              item: true,
              title: false,
              text:
                "Por eso desde la escuela, una ONG, un club, empresas y otras instituciones se pueden organizar campañas de reciclaje que promuevan el reciclado de toda clase de residuos. Las campañas de reciclaje tienen un tiempo de comienzo y fin establecidos, si no se convierten en programas. Hay una fecha de comienzo y otra de finalización.",
            },
            {
              item: true,
              title: false,
            ...
            },
            {
              ...
              title: false,
              text:
                "Cuando se concluye la campaña se debe informar los resultados en diferentes medio para que los que participaron sepan como termino y lo que se logro.",
            },
            {
              item: true,
              title: false,
              text:
                "Las campañas de reciclaje puede repetirse pero es conveniente ser creativo y comunicar en forma distinta.",
            },
            {
              item: false,
              title: false,
              text:
                "Una campaña de reciclaje pueden ser locales, regionales e incluso nacionales. Pueden centrarse en gran cantidad de productos o materiales que son residuos pero que no deben ser desechados ya que generarían contaminación además de desaprovechar recursos.",
            },
            {
              item: false,
              title: false,
            ...
            },
            {
              ...
              title: false,
              text:
                "Una buena campaña de reciclaje debe concientizar e informar sobre la necesidad del reciclaje y dar información de cómo hacerlo.",
            },
            {
              item: false,
              title: false,
              text:
                "¿Has organizado alguna vez una campaña de reciclaje? ¿Qué pasos a seguido para organizarla?",
            },
            {
              item: false,
              title: false,
              text:
                "A continuación te dejamos algunos ejemplos de campañas en el mundo",
            },
          ],
        },
        {
          ...
          textClass: [
            ...
            },
            {
              ...
              title: false,
              text:
                "A modo de ejemplo veamos el ciclo de reciclado del plástico.",
            },
            {
              item: false,
              title: false,
            ...
            },
            {
              ...
              title: false,
              text:
                "Recomendación: Limpia los envases y aplástalos para reducir su volumen antes de tirarlos al contenedor. Fuente: https://www.renovablesverdes.com/contenedores-reciclaje/?utm_source=destacado-inside",
            },
          ],
        },
        {
          ...
          textClass: [
            ...
            },
            {
              ...
              title: false,
              text:
                "El reciclado es un proceso cuyo objetivo es convertir residuos en nuevos productos o en materia prima para su posterior utilización.",
            },
            {
              item: false,
              title: false,
        ...
        },
        {
          ...
          textClass: [
            ...
            },
            {
              ...
              title: false,
              text:
                "Seguro que si estás leyendo este post es porque te preocupa el medio ambiente y colaboras, en tu día a día, en su cuidado y conservación.",
            },
            {
              item: false,
              title: false,
              text:
                "Un buen método de hacerlo, y muy sencillo, es mediante el reciclaje, ya que son muchos los beneficios que reporta.",
            },
            {
              item: false,
              title: false,
              text:
                "En este post queremos hablarte de 5 de las contribuciones que aporta el reciclado al conjunto de la sociedad. Y es que esta actividad es muy positiva, por lo que si todavía no la has incorporado a tus hábitos cotidianos, ¿a qué estás esperando?:",
            },
            {
              item: false,
              title: true,
  ...
  },
  {
    ...
    detailCard:
      "Aprovechando la pandemia por la que estamos atravesando y la obligación del uso del tapaboca...",
    presentation: [
      {
        item: false,
        text:
          "Aprovechando la pandemia por la que estamos atravesando y la obligación del uso del tapaboca vamos a aprender a confeccionar dos modelos de ellos y a meternos un poco en un taller de confección, ya que podemos convertir esta actividad en una salida laboral.",
      },
      {
        item: false,
          ...
          textClass: [
            {
              ...
              title: false,
              text:
                "En medio de la pandemia por la nueva cepa de coronavirus y la disposición de aislamiento obligatorio en gran parte del mundo, una de las medidas que se ha tomado en las últimas semanas es el uso de barbijos o tapabocas.",
            },
            {
              item: false,
              title: true,
              text:
                "¿Cuál es la mejor tela para que el elemento cumpla con su función y sea realmente efectivo?",
            },
            {
              item: false,
              title: false,
              text:
                "Hacerlo en casa permite reducir algunos costos y que sea un producto reutilizable, pero también es necesario tener en cuenta la importancia que tiene la tela. No todas son aptas para ser usadas como tapabocas, dado que algunas muy porosas y abiertas pueden permitir el paso de las gotas de respiración, tos o estornudos que contagian el coronavirus y otras enfermedades.",
            },
            {
              item: false,
              title: false,
            ...
            },
            {
              ...
              title: false,
              text:
                "Las autoridades argentinas difundieron información acerca de cómo es la mejor forma de hacerlos y utilizarlos. ",
            },
            {
              item: false,
              title: false,
